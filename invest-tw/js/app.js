var app = new Vue({
    ...
    methods: {
        getStockLogs: function(stock_code) {            
            axios.get(`https://jojocat-poc-default-rtdb.firebaseio.com/tw-stock/logs/${stock_code}.json`).then(function(res){
    ...
    mounted: function(){
        ...
        axios.get(`https://jojocat-poc-default-rtdb.firebaseio.com/tw-stock/bt.json`).then(function(res){
            this.BackTradeRecords = res.data.sort( (a,b) => b.irr - a.irr);
        }.bind(this));        
        axios.get(`https://jojocat-poc-default-rtdb.firebaseio.com/tw-stock/target_prices.json`).then(function(res){
