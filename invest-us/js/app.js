var app = new Vue({
    ...
    mounted: function(){
        ...
        axios.get(`https://invest-8738f-default-rtdb.firebaseio.com/us-stock/bt.json`).then(function(res){
            this.BackTradeRecords = res.data.sort( (a,b) => b.irr - a.irr);
        }.bind(this));        
        axios.get(`https://invest-8738f-default-rtdb.firebaseio.com/us-stock/target_prices.json`).then(function(res){
